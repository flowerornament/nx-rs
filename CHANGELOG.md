...
- publishes the producer-owned Nix package runtime closure for all four supported systems to the public flowerornament Cachix cache, proves tokenless substitution on fresh native runners, and refuses to tag or advance `release` until every output is cache-ready
