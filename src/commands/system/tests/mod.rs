...
use super::upgrade::{
    CommitOutcome, FlakeLockTransaction, NixConfig, brew_compare_url, build_upgrade_commit_message,
    commit_upgrade_paths, flake_compare_endpoint, flake_compare_url, maybe_ai_summary,
